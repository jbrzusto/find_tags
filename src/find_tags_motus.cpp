...
main (int argc, char **argv) {
  ...
  force_default_freq = vm.count("force_default_freq");
  unsigned_dfreq     = vm.count("unsigned_dfreq");
  src_sqlite         = vm.count("src_sqlite");
  lotek              = vm.count("lotek");
  use_events         = vm.count("use_events");
  resume             = vm.count("resume");
  info_only          = vm.count("info_only");
  test_only          = vm.count("test_only");
  graph_only         = vm.count("graph_only");
  pulses_only        = vm.count("pulses_only");
