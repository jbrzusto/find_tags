...
## DEBUG FLAGS:
##CPPFLAGS=-fpermissive -Wall -Wno-sign-compare -g3 -std=c++0x $(PROFILING) -DPROGRAM_VERSION=$(PROGRAM_VERSION) -DPROGRAM_BUILD_TS=$(PROGRAM_BUILD_TS) -I/home/src/boost_1_54_0
...
LDFLAGS=-ldl -lrt -lboost_serialization
...
find_tags_motus: Freq_Setting.o Freq_History.o Set.o Node.o Graph.o Tag.o Tag_Database.o Pulse.o Tag_Candidate.o Tag_Finder.o Rate_Limiting_Tag_Finder.o find_tags_motus.o Tag_Foray.o DB_Filer.o History.o Ticker.o sqlite3.o  Ambiguity.o
...
testAddRemoveTag.o: testAddRemoveTag.cpp Graph.o Tag_Database.o sqlite3.o Freq_Setting.o DB_Filer.o

testAddRemoveTag: testAddRemoveTag.o Tag_Database.o sqlite3.o Tag.o Node.o Set.o Graph.o Freq_Setting.o History.o Ticker.o Ambiguity.o DB_Filer.o Tag_Candidate.o
