...
usage() {
  puts (
	...
	"    default: Inf (i.e. no minimum)\n\n"
        ...
        "-N, --dump_line_numbers\n"
        "    if specified, populate the hitLines table giving the line numbers of pulses in a tag detection.\n\n"
...
main (int argc, char **argv) {
    ...
    int option_index;
    static const char short_options[] = "b:B:c:ef:FgG:hi:l:Lm:M:n:Np:rR:s:S:tuw:x:";
	...
	{"pulses_to_confirm"	   , 1, 0, OPT_PULSES_TO_CONFIRM},
        ...
        {"dump_line_numbers"       , 0, 0, OPT_DUMP_LINE_NUMBERS},
	...
	case OPT_FORCE_DEFAULT_FREQ:
        ...
        case OPT_BOOT_NUM:
          ...
          break;
        case OPT_DUMP_LINE_NUMBERS:
          dump_line_numbers = true;
          break;
        case OPT_SIG_SLOP:
    ...
    Tag_Candidate::set_dump_line_numbers(dump_line_numbers);
    ...
    try {
      ...
      DB_Filer dbf (output_filename, program_name, program_version, program_build_ts, bootNum, GPS_min_dt, dump_line_numbers);
